...
public class Order implements Serializable {
	...
	/*
	 * Como o relacionamento é de um para um aqui está 
	 * se mapeando as duas entidades para ter o mesmo id
	 * se o pedido for codigo 5 o pagamento desse pedido
	 * também vai ter codigo 5, e nesse caso de mapear
	 * de um para um com o mesmo Id é obrigatorio usar
	 * o atributo cascade = CascadeType.ALL
	 */
